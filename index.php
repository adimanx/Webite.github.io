...
<html lang="en">
  ...
  <body>
    ...
    <section class="home-slider owl-carousel">
        ...
        <div class="container">
          <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">
            ...
            <div class="col-md-8 col-sm-12 text-center ftco-animate">
              ...
              <p class="mb-4 mb-md-5">A small river named Duden flows by their place and supplies it with the necessary regelialia.</p>
              <p><a href="shop.html" class="btn btn-primary p-3 px-xl-4 py-xl-3">Order Now</a> <a href="#" class="btn btn-white btn-outline-white p-3 px-xl-4 py-xl-3">View Menu</a></p>
            </div>
      ...
      <div class="slider-item" style="background-image: url(images/img18.jpg);">
      	<div class="overlay"></div>
        <div class="container">
          <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">
    ...
    <section class="ftco-intro">
    	<div class="container-wrap">
    		<div class="wrap d-md-flex align-items-xl-end">
	    		...
	    		<div class="book p-4">
	    			<h3>Book a Table</h3>
	    			<form action="" method="POST" id="appoinment_form" class="appointment-form">
	    				<div class="d-md-flex">
                  ...
                  <span id="fname_error"></span>
	    				...
	    				<div class="d-md-flex">
		            		...
		            		<input type="text" class="form-control appointment_date" name="date" id="date" placeholder="Date">
	            		</div>
		    				</div>
		    				<div class="form-group ml-md-4">
		    					<div class="input-wrap">
		            		<div class="icon"><span class="ion-ios-clock"></span></div>
		            		<input type="text" class="form-control appointment_time" name="time" id="time" placeholder="Time">
	            		</div>
		    				</div>
		    				<div class="form-group ml-md-4">
	    				...
	    				<div class="d-md-flex">
	    					<div class="form-group">
		              <textarea cols="30" rows="2" class="form-control" name="message" id="message" placeholder="Message"></textarea>
		            </div>
		            <div class="form-group ml-md-4">
		              <input type="button" value="Appointment" name="submit" id="book_appoinment" class="btn btn-white py-3 px-4">
		            </div>
	    				</div>
	    			</form>
	    		</div>
    ...
    <section class="ftco-section ftco-services" style="background-color: white;">
    	<div class="container">
    		<div class="row">
        	...
        	<div class="col-md-3">
        		<div class="menu-entry">
    					...
    					<div class="text text-center pt-4">
    						<h3><a href="#">Coffee Capuccino</a></h3>
    						<p>A small river named Duden flows by their place and supplies</p>
    						<p class="price"><span>Rs.465</span></p>
    						<p><a href="#" class="btn btn-primary btn-outline-primary">Add to Cart</a></p>
    					</div>
    				</div>
        	</div>
        	<div class="col-md-3">
        		<div class="menu-entry">
    					...
    					<div class="text text-center pt-4">
    						<h3><a href="#">Coffee Capuccino</a></h3>
    						<p>A small river named Duden flows by their place and supplies</p>
    						<p class="price"><span>Rs.456</span></p>
    						<p><a href="#" class="btn btn-primary btn-outline-primary">Add to Cart</a></p>
    					</div>
    				</div>
        	</div>
		            ...
		            <div class="tab-content ftco-animate" id="v-pills-tabContent">
		              ...
		              <div class="tab-pane fade show active" id="v-pills-1" role="tabpanel" aria-labelledby="v-pills-1-tab">
		              	<div class="row">
		              		<div class="col-md-4 text-center">
		              			<div class="menu-wrap">
		              				<a href="#" class="menu-img img mb-4" style="background-image: url(images/img15.jpg);"></a>
		              				<div class="text">
		              		...
		              		<div class="col-md-4 text-center">
		              			<div class="menu-wrap">
		              				<a href="#" class="menu-img img mb-4" style="background-image: url(images/img11.jpg);"></a>
		              				<div class="text">
		              					<h3><a href="#">Layered rainbbow Cake</a></h3>
		              					<p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia.</p>
		              					<p class="price"><span>Rs.330/-</span></p>
		              					<p><a href="#" class="btn btn-primary btn-outline-primary">Add to cart</a></p>
		              				</div>
		              			</div>
		              		</div>
		              		<div class="col-md-4 text-center">
		              			<div class="menu-wrap">
		              				<a href="#" class="menu-img img mb-4" style="background-image: url(images/img30.jpg);"></a>
		              				<div class="text">
		              					<h3><a href="#">Chickpea salad Sandwich</a></h3>
		              					<p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia.</p>
		              					<p class="price"><span>Rs.263/-</span></p>
		              					<p><a href="#" class="btn btn-primary btn-outline-primary">Add to cart</a></p>
		              				</div>
		              			</div>
		              		</div>
		              ...
		              <div class="tab-pane fade" id="v-pills-3" role="tabpanel" aria-labelledby="v-pills-3-tab">
		                <div class="row">
		              		<div class="col-md-4 text-center">
		              			<div class="menu-wrap">
		              				<a href="#" class="menu-img img mb-4" style="background-image: url(images/img13.jpg);"></a>
		              				<div class="text">
		              		...
		              		<div class="col-md-4 text-center">
		              			<div class="menu-wrap">
		              				<a href="#" class="menu-img img mb-4" style="background-image: url(images/img10.jpg);"></a>
		              				<div class="text">
		              					<h3><a href="#">Hot Cake Honey</a></h3>
		              					<p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia.</p>
		              					<p class="price"><span>Rs.280/-</span></p>
		              					<p><a href="#" class="btn btn-primary btn-outline-primary">Add to cart</a></p>
		              				</div>
		              			</div>
		              		</div>
		              		<div class="col-md-4 text-center">
		              			<div class="menu-wrap">
		              				<a href="#" class="menu-img img mb-4" style="background-image: url(images/img23.jpg);"></a>
		              				<div class="text">
		              					<h3><a href="#">Chocolate Cake </a></h3>
		              					<p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia.</p>
		              					<p class="price"><span>Rs.360/-</span></p>
		              					<p><a href="#" class="btn btn-primary btn-outline-primary">Add to cart</a></p>
		              				</div>
		              			</div>
		              		</div>
            ...
            <div class="ftco-footer-widget mb-4">
              ...
              <div class="block-21 mb-4 d-flex">
                ...
                <div class="text">
                  ...
                  <div class="meta">
                    <div><a href="#"><span class="icon-calendar"></span> Sept 15, 2020</a></div>
...
<script type="text/javascript">
  $(document).ready(function()
 {
   ...
   if( ! /^[a-zA-Z]+$/.test($('#first_name').val()))
    ...
    else if($('#phone').val() == '' || ! /^[0-9]{10}$/.test($('#phone').val()))
    {
    ...
    else if($('#message').val() == '')
    {
      alert("Please Give us feedback");
      ...
      else
       {
        ...
        $.ajax
         ({
             url:"models/insert_booking.php",
             method:"POST",
             data:$('#appoinment_form').serialize(),
             success:function(res)
      
              {
                toastr.success(res,'Sucess',{timeOut:1000});
               }
